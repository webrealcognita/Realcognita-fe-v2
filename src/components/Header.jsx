...
/**
 * Header / Nav — converted 1:1 from the original js/components.js NAV_HTML.
 * Rendered via dangerouslySetInnerHTML to guarantee pixel-identical markup
 * (ids/classes are targeted directly by public/js/main.js, theme.js, chatbot.js).
 */
export default function Header() {
  return (
    <div
      id="rc-header-root"
      dangerouslySetInnerHTML={{ __html: `<a href="#main-content" class="skip-link">Skip to content</a>
...
<!-- ===================== NAVIGATION BAR START ===================== -->
    ...
    <div class="header-inner">
      ...
      <!-- Logo Container -->
      <a href="/" class="header-logo" aria-label="Realcognita – Home">
                ...
                <div class="sector-panels-wrapper">
                  ...
                  <div class="sector-content-panel active" id="residential-panel">
                    <div class="orascom-layout-grid">
                      ...
                      <div class="orascom-feature-col">
                        <div class="orascom-img-frame">
                          <a href="/production_estimating">
                            <img src="./assets/meganavigation_hover/mega_image_2.jpg" alt="Production Estimating" />
                          </a>
                        </div>
                        <h3><a href="/production_estimating" class="orascom-title-link">Production Estimating</a></h3>
                      ...
                      <div class="orascom-feature-col">
                        <div class="orascom-img-frame">
                          <a href="/3d-rendering-and-visualizations">
                          <img src="./assets/meganavigation_hover/mega_image_4.jpg" alt="3D Rendering & Visualisation" />
                          </a>
                        </div>
                        <h3><a href="/3d-rendering-and-visualizations" class="orascom-title-link">3D Visualization</a></h3>
                  ...
                  <div class="sector-content-panel" id="commercial-panel">
                    <div class="orascom-layout-grid">
                      ...
                      <div class="orascom-feature-col">
                        <div class="orascom-img-frame">
                          <a href="/engineering_dtl">
                          <img src="./assets/meganavigation_hover/mega_image_7.jpg" alt="Engineering Detail & Modelling" />
                          </a>
                        </div>
                        <h3><a href="/engineering_dtl" class="orascom-title-link">Engineering Detail & Modelling</a></h3>
                      ...
                      <div class="orascom-feature-col">
                        <div class="orascom-img-frame">
                          <a href="/bim-modelling-services">
                          <img src="./assets/meganavigation_hover/mega_image_8.webp" alt="BIM Services" />
                          </a>
                        </div>
                        <h3><a href="/bim-modelling-services" class="orascom-title-link">BIM Services</a></h3>
                      ...
                      <div class="orascom-feature-col">
                        <div class="orascom-img-frame">
                          <a href="/rebar-services">
                          <img src="./assets/meganavigation_hover/mega_image_9.webp" alt="Rebar Services" />
                          </a>
                        </div>
                        <h3><a href="/rebar-services" class="orascom-title-link">Rebar Services</a></h3>
                      ...
                      <div class="orascom-directory-col">
                        <span class="directory-heading">Learn More</span>
                        <ul class="directory-links-list">
                          <li><a href="/infrastructure-support">Infrastructure Support</a></li>
                          <li><a href="/drafting">Drafting</a></li>
                          <li><a href="/production-scheduling">Production Scheduling</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <div class="standard-dropdown profile-dropdown-box">
              <div class="dropdown-split-container">
                ...
                <div class="dropdown-teaser-pane">
                  ...
                  <a href="/about-us" class="teaser-action-link">Learn More</a>
                </div>
                ...
                <div class="dropdown-links-pane">
                  ...
                  <ul class="pane-links-list">
                    <li>
                      <a href="/about-us" class="pane-tile-item">
                    ...
                    <li>
                      <a href="/our-team" class="pane-tile-item">
                    ...
                    <li>
                      <a href="/careers" class="pane-tile-item">
            ...
            <div class="standard-dropdown profile-dropdown-box">
              <div class="dropdown-split-container">
                ...
                <div class="dropdown-teaser-pane">
                  ...
                  <a href="/case_studies" class="teaser-action-link">Learn More</a>
                </div>
                ...
                <div class="dropdown-links-pane">
                  ...
                  <ul class="pane-links-list">
                    <li>
                      <a href="/case_studies" class="pane-tile-item">
                    ...
                    <li>
                      <a href="/testimonials" class="pane-tile-item">
                    ...
                    <li>
                      <a href="/white-papers" class="pane-tile-item">
          ...
          <div class="standard-dropdown profile-dropdown-box">
            <div class="dropdown-split-container">
              ...
              <div class="dropdown-teaser-pane">
                  ...
                  <a href="/blog" class="teaser-action-link">Learn More</a>
              </div>
              ...
              <div class="dropdown-links-pane">
                ...
                <ul class="pane-links-list">
                  <li>
                    <a href="/blog" class="pane-tile-item">
...
<nav class="mobile-drawer" id="mobileDrawer" aria-hidden="true" aria-label="Mobile navigation">
    ...
    <div class="drawer-links">
        ...
        <div class="accordion-body">
          <div class="accordion-body-inner">
            ...
            <div class="drawer-sector-group">
              ...
              <a href="/production_estimating" class="drawer-link">Production Estimating</a>
              <a href="/administrative-support" class="drawer-link">Administrative Support</a>
              <a href="/3d-rendering-and-visualizations" class="drawer-link">3D Rendering &amp; Visualisation</a>
              <a href="/project-management" class="drawer-link">Project Management</a>
              <a href="/residential-engineering" class="drawer-link">Residential Engineering</a>
            </div>

            <div class="drawer-sector-group">
              <span class="drawer-sector-title">Commercial Sector</span>
              <a href="/engineering_dtl" class="drawer-link emphasis-link">Engineering Detail &amp; Modelling</a>
              <a href="/bim-modelling-services" class="drawer-link">BIM Modelling Services</a>
              <a href="/rebar-services" class="drawer-link">Rebar Services</a>
              <a href="/infrastructure-support" class="drawer-link">Infrastructure Support</a>
              <a href="/drafting" class="drawer-link">Drafting</a>
              <a href="/production-scheduling" class="drawer-link">Production Scheduling</a>
            </div>
      ...
      <div class="accordion">
        ...
        <div class="accordion-body">
          <div class="accordion-body-inner">
            ...
            <a href="/our-team" class="drawer-link">Our Team</a>
            <a href="/careers" class="drawer-link">Careers</a>
          </div>
        </div>
      </div>
      ...
      <div class="accordion">
        ...
        <div class="accordion-body">
          <div class="accordion-body-inner">
            <a href="/case_studies" class="drawer-link">Case Studies</a>
            <a href="/testimonials" class="drawer-link">Testimonials</a>
            <a href="/white-papers" class="drawer-link">White Papers</a>
          </div>
        </div>
      </div>
      ...
      <div class="accordion">
        ...
        <div class="accordion-body">
          <div class="accordion-body-inner">
            <a href="/blog" class="drawer-link">News &amp; Articles</a>
          </div>
        </div>
      </div>
